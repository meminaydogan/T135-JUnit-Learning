...
public class C07_AssertionMethodlari {
    ...
    public void test01(){
        ...
        Assert.assertTrue("Anasayfa testi PASSED",actualUrl.contains(expectedUrlIcerik));
    ...
    public void test02(){
        ...
        Assert.assertTrue("Urun arama testi PASSED",bulunanUrunElementleriList.size()==0);
    ...
    public void test03(){
        ...
        String actualIsimKucukHarf = driver.findElement(By.xpath("//div[@class=' heading-sm mb-4']"))
                .getText()
                .toLowerCase();
        Assert.assertTrue("Urun isim testi PASSED",actualIsimKucukHarf.contains(expectedUrunIsimIcerik));
